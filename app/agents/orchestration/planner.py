...
from app.agents.orchestration.task_profiles import AbstractTaskNode, TaskProfile, compile_abstract_tasks
...
class LlmPlanner(Planner):
    ...
    async def _call_structured_planner(self, user_id: str, request: str, context: str,
        ...
        try:
            ...
            if code in {"MODEL_INSUFFICIENT_BALANCE", "MODEL_AUTH_ERROR", "MODEL_NOT_FOUND", "MODEL_CONFIG_ERROR",
