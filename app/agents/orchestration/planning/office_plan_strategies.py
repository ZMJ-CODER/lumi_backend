...
def workspace_read_path(
    ...
    if target is None:
        return None
    from app.knowledge.api import requires_complete_read
...
def inject_workspace_discovery(tree, request: str, planning_context) -> TaskTree:
    ...
    from app.agents.orchestration.office.workspace_content import workspace_bulk_intent
