...
from app.agents.orchestration.recovery.replan_policy import decide_logical_plan_replan
...
class LogicalPlanReplanService:
    ...
    async def replan(
        ...
        *,
        ...
        from app.agents.orchestration.execution.presentation import attach_display_plan
        ...
        await self._store.save_job(job)
        try:
            from app.observability.observability import inc_agent_replan
