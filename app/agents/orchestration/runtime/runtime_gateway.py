...
class RuntimeGateway:
    ...
    def can_run_static(job: Job) -> bool:
        ...
        """
        from app.agents.orchestration.runtime.temporal_policy import evaluate_static_temporal
    ...
    def static_rollout_eligibility(job: Job):
        ...
        """
        from app.agents.orchestration.runtime.temporal_policy import StaticTemporalDecision
    ...
    def logical_read_rollout_eligibility(job: Job, plan: dict | None):
        ...
        from app.agents.orchestration.runtime.temporal_policy import (
