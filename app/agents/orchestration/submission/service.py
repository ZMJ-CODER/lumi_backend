...
from app.agents.orchestration.preflight.capability_preflight_service import attach_capability_resolution_time
...
from app.agents.orchestration.admission.admission import job_admission
...
def _capability_requirements(*, scene: str, request: str, office_docs: list[dict] | None):
    ...
    """
    from app.platform.model.model_capability_router import CapabilityRequirements
...
class JobSubmissionService:
    ...
    async def _blocked_by_model_capability(
        ...
        *,
        ...
        from app.platform.model.model_capability_router import attach_model_routing
    ...
    async def submit(
        ...
        *,
        ...
        try:
            from app.platform.model.model_plan import build_model_plan
        ...
        from app.agents.orchestration.runtime.timeout_ladder import describe_budget
        ...
        from app.agents.capabilities.policy.policy_packs import select_policy_id
        from app.agents.capabilities.views.snapshots import attach_job_snapshots
        ...
        # 只记录、不改行为，且失败绝不影响提交。
        try:
            from app.agents.capabilities.views.tool_shadow import log_shadow_differences
        ...
        if scene == "office":
            from app.observability.observability import inc_planner_invoked
