...
from app.knowledge.config import effective_threshold, effective_top_k
from app.knowledge.parsing.chunker import chunk_document
from app.knowledge.parsing.classifier import classify_document, normalize_category
...
from app.knowledge.parsing.cleaner import HARD_FAIL_CODES, DocumentQualityError, assess_document, clean_document
from app.knowledge.parsing.document_parser import parse_document_with_metadata
...
async def search_user_knowledge(
    ...
    if rerank_enabled and settings.RAG_RERANK_ENABLED and fused:
        from app.knowledge.retrieval.reranker import rerank
    ...
    try:
        from app.observability.observability import inc_rag_search
