...
class DefaultMemoryRepository:
    ...
    async def record_task_index(self, job: Job) -> None:
        ...
        try:
            ...
            from app.memory.office_tasks import upsert_office_task_index
    ...
    async def load_recall_context(
        ...
        try:
            from app.memory.office_tasks import (
    ...
    async def load_presentation_preferences(self, user_id: str) -> str:
        try:
            from app.core.database import async_session_factory
            from app.memory.office_tasks import get_office_presentation_preferences
