...
async def promote_session_to_knowledge(
    ...
    from app.core.database import async_session_factory
    from app.models.db_models import OfficeSession
    from app.knowledge.api import upload_document_file
    ...
    async with async_session_factory() as db:
        ...
        if is_new:
            ...
            from app.knowledge.api import record_document_enqueue
...
def extract_full_text(user_id: str, doc_id: str) -> str:
    ...
    if kind in {e.lstrip(".") for e in DOCLING_EXTS}:
        ...
        from app.knowledge.api import parse_document
...
async def ensure_rag_index(user_id: str, doc_id: str) -> dict:
    ...
    from app.core.database import async_session_factory
    from app.knowledge.api import create_space, process_document_pipeline, upload_document_file
...
async def analyze_doc(
    ...
    from app.core.database import async_session_factory
    from app.office.api import office_llm
