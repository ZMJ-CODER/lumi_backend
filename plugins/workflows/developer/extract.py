...
class ExtractInfoSkill(WorkflowSkill):
    name = "extract_info"
    ...
    async def execute(self, params: dict, context: SkillContext | None = None) -> ToolOutput:
        ...
        return ToolOutput(success=True, output=out, metadata={"format": "json"})


class InvoiceParseSkill(WorkflowSkill):
    name = "invoice_parse"
...
class ComplianceCheckSkill(WorkflowSkill):
