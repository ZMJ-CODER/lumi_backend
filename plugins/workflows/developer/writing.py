...
def _ok(text: str) -> ToolOutput:
    return ToolOutput(success=True, output=text)
...
class ComposeEmailSkill(WorkflowSkill):
    name = "compose_email"
...
class ComposeOfficialDocSkill(WorkflowSkill):
...
class RewriteTextSkill(WorkflowSkill):
    name = "rewrite_text"
...
class SummarizeTextSkill(WorkflowSkill):
    name = "summarize_text"
...
class MeetingMinutesSkill(WorkflowSkill):
