...
import json
from app.knowledge.retrieval.query_rewriter import _rewrite_local, get_retrieval_queries, should_expand_query
from app.knowledge.parsing.document_parser import ParsedDocument, ParsedSegment, parse_document_with_metadata
from app.knowledge.parsing.chunker import chunk_structured
...
def test_local_query_rewriter_rejects_vision_model(monkeypatch):
    from app.knowledge.retrieval import query_rewriter
...
def test_pdf_parser_contract_keeps_page_segments(monkeypatch, tmp_path):
    from app.knowledge.parsing import document_parser
...
def test_sparse_experiment_is_disabled_by_default(monkeypatch):
    from app.knowledge.embedding import sparse_embeddings
...
def test_reranker_is_a_noop_when_feature_is_disabled(monkeypatch):
    from app.knowledge.retrieval import reranker
