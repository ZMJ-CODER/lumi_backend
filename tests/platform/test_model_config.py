...
from app.platform.model.llm_config import _env_fallback, _resolve_user_cfg, get_llm_config, resolve_effective_llm_config
...
def test_effective_config_falls_back_to_server_key_for_builtin_byok(monkeypatch):
    ...
    monkeypatch.setattr("app.platform.model.llm_config.get_llm_config", fake_config)
